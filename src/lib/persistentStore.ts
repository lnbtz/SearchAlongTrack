...
import {
	// gpxTrackStore, // Commented out to avoid unused variable warning
	selectedCategoriesStore,
	selectedRadiusStore,
	// searchResultsCacheStore, // Commented out to avoid unused variable warning
	tableDataStore,
	selectedStartRangeStore,
	selectedEndRangeStore
	// markersStore, // Commented out to avoid unused variable warning
	// tableDataDisplayStore // Commented out to avoid unused variable warning
} from './stores';
import { browser } from '$app/environment';
import { saveAppState, getAppState, type AppState } from './storage';
