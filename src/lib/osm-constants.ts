...
export const QueryBodies = [
  {
    key: "AMENITIES_WITH_VENDING",
    query: `["${OSMCategories.key.AMENITY}"~"${OSMCategories.value.SHELTER}|${OSMCategories.value.TOILETS}|${OSMCategories.value.DRINKING_WATER}|${OSMCategories.value.CAFE}|${OSMCategories.value.FUEL}|${OSMCategories.value.ICE_CREAM}|${OSMCategories.value.RESTAURANT}|${OSMCategories.value.BICYCLE_REPAIR_STATION}"]`,
  },
  {
    key: "AMENITY_VENDING",
